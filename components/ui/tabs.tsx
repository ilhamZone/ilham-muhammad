...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-[30px] xl:bg-white p-1 text-muted-foreground dark:bg-background dark:lg:bg-secondary",
      className
    )}
    {...props}
  />
